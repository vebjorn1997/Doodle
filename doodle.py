...
def draw_circle(t: Turtle, startpos: tuple[float, float], radius: float, color: tuple[int, int, int] = (0,0,0), fill: bool = False):
    """
...
def draw_norway_flag(t: Turtle, start_x: int = 0, start_y: int = 0, fraction_size: int = 10):
    """
    ...
    """
    # White
    draw_rectangle(t, (start_x, start_y), fraction_size*16, fraction_size*22, (255, 255, 255), True)

    # Red
    draw_rectangle(t, (start_x, start_y), fraction_size*6, fraction_size*6, (186, 12, 47), True)
    draw_rectangle(t, (start_x, start_y-fraction_size*10), fraction_size*6, fraction_size*6, (186, 12, 47), True)
    draw_rectangle(t, (start_x+fraction_size*10, start_y), fraction_size*6, fraction_size*12, (186, 12, 47), True)
    draw_rectangle(t, (start_x+fraction_size*10, start_y-fraction_size*10), fraction_size*6, fraction_size*12, (186, 12, 47), True)

    # Blue
    draw_rectangle(t, (start_x, start_y-fraction_size*7), fraction_size*2, fraction_size*22, (0, 32, 91), True)
    draw_rectangle(t, (start_x+fraction_size*7, start_y) , fraction_size*16, fraction_size*2, (0, 32, 91), True)

    # Border
    draw_rectangle(t, (start_x, start_y), fraction_size*16, fraction_size*22)

def draw_sweden_flag(t: Turtle, start_x: int = 0, start_y: int = 0, fraction_size: int = 10):
    """
    ...
    """
    # Yellow
    draw_rectangle(t, (start_x, start_y), fraction_size*10, fraction_size*16, (254, 204, 2), True)

    # Blue
    draw_rectangle(t, (start_x, start_y), fraction_size*4, fraction_size*5, (0, 82, 147), True)
    draw_rectangle(t, (start_x, start_y-fraction_size*6), fraction_size*4, fraction_size*5, (0, 82, 147), True)
    draw_rectangle(t, (start_x+fraction_size*7, start_y), fraction_size*4, fraction_size*9, (0, 82, 147), True)
    draw_rectangle(t, (start_x+fraction_size*7, start_y-fraction_size*6), fraction_size*4, fraction_size*9, (0, 82, 147), True)

    # Border
    draw_rectangle(t, (start_x, start_y), fraction_size*10, fraction_size*16)

def draw_bangladesh_flag(t: Turtle, start_x: int = 0, start_y: int = 0, fraction_size: int = 10):
    """
    ...
    """
    # Green
    draw_rectangle(t, (start_x, start_y), fraction_size*12, fraction_size*20, (0, 106, 78), True)

    # Dot
    draw_circle(t, (start_x+fraction_size*9, start_y-fraction_size*6), fraction_size*8, (244,42,65), True)
